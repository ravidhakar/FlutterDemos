...
NextPageDataModel moviesMainFromJson(String str) =>
    NextPageDataModel.fromJson(json.decode(str));

String moviesMainToJson(NextPageDataModel data) => json.encode(data.toJson());

class NextPageDataModel {
  NextPageDataModel({
    this.movies,
  });
  ...
  factory NextPageDataModel.fromJson(Map<String, dynamic> json) =>
      NextPageDataModel(
